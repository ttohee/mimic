...
export function Icon({ name, size = 20, className, style }: IconProps) {
  ...
  const paths: Record<IconName, React.ReactNode> = {
    home:     <><path {...p} d="M3 11.5 12 4l9 7.5" /><path {...p} d="M5 10v9h14v-9" /></>,
    cards:    <><rect {...p} x="3" y="5" width="13" height="15" rx="2.5" /><path {...p} d="M8 4.5 19 7l-2.2 12" /></>,
    doc:      <><path {...p} d="M6 3h8l4 4v14H6z" /><path {...p} d="M14 3v4h4" /><path {...p} d="M9 12h6M9 16h4" /></>,
    trophy:   <><path {...p} d="M7 4h10v4a5 5 0 0 1-10 0z" /><path {...p} d="M7 6H4v1a3 3 0 0 0 3 3M17 6h3v1a3 3 0 0 1-3 3" /><path {...p} d="M12 13v3M9 20h6M10 20v-2.5h4V20" /></>,
    user:     <><circle {...p} cx="12" cy="8" r="3.5" /><path {...p} d="M5 20c0-3.5 3-5.5 7-5.5s7 2 7 5.5" /></>,
    ...
    logout:   <><path {...p} d="M14 4h4a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1h-4" /><path {...p} d="M9 12h10M15 8l4 4-4 4" /></>,
